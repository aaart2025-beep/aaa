...
export const shop: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "shop.catHeadwear": "Hats",
    "shop.catFootwear": "Shoes",
    "shop.catArtObject": "Art & Home",
    "shop.catHoodies": "Hoodies",
    "shop.catShirts": "Shirts",
    "shop.catTops": "Tops",
    "shop.catPants": "Pants",
    "shop.catSportswear": "Sportswear",
    "shop.catSale": "Sale",
    "shop.dimensions": "Dimensions",
    "shop.dimHeight": "Height",
    "shop.dimWidth": "Width",
    "shop.dimDepth": "Depth",
  ...
  he: {
    ...
    "shop.catFootwear": "נעליים",
    "shop.catArtObject": "אומנות / אביזרים לבית",
    "shop.catHoodies": "הודיס",
    "shop.catShirts": "חולצות",
    "shop.catTops": "טופים",
    "shop.catPants": "מכנסיים",
    "shop.catSportswear": "בגדי ספורט",
    "shop.catSale": "מבצע",
    "shop.dimensions": "ממדים",
    "shop.dimHeight": "גובה",
    "shop.dimWidth": "רוחב",
    "shop.dimDepth": "עומק",
