...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${t("policies.care.title")} — AAA`,
    description: t("policies.care.metaDescription"),
    alternates: { canonical: "/policies/care" },
  };
}

export default async function CarePolicyPage() {
  const lang = await getLang();
  const t = (k: string) => translate(lang, k);
  return (
    <PaperShell>
